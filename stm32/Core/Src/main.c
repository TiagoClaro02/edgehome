...
/* Definitions for SensorActuator */
osThreadId_t SensorActuatorHandle;
const osThreadAttr_t SensorActuator_attributes = {
  .name = "SensorActuator",
  .stack_size = 256 * 4,
...
void SensorActuatorTask(void *argument);
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of SensorActuator */
  SensorActuatorHandle = osThreadNew(SensorActuatorTask, NULL, &SensorActuator_attributes);
...
/* USER CODE BEGIN Header_SensorActuatorTask */
/**
  * @brief  Function implementing the SensorActuator thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_SensorActuatorTask */
void SensorActuatorTask(void *argument)
{
  /* USER CODE BEGIN 5 */
  SensorActuatorTaskImpl(argument);
  /* USER CODE END 5 */
}
