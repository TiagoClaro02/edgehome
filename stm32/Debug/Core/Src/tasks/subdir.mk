...
Core/Src/tasks/sensor_actuator_task.o: ../Core/Src/tasks/sensor_actuator_task.c Core/Src/tasks/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32F411xE -c -I../Core/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc/Legacy -I../Middlewares/Third_Party/FreeRTOS/Source/include -I../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2 -I../Middlewares/Third_Party/FreeRTOS/Source/portable/GCC/ARM_CM4F -I../Drivers/CMSIS/Device/ST/STM32F4xx/Include -I../Drivers/CMSIS/Include -I../Drivers/csrc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
...
clean-Core-2f-Src-2f-tasks:
	-$(RM) ./Core/Src/tasks/sensor_actuator_task.cyclo ./Core/Src/tasks/sensor_actuator_task.d ./Core/Src/tasks/sensor_actuator_task.o ./Core/Src/tasks/sensor_actuator_task.su ./Core/Src/tasks/system_task.cyclo ./Core/Src/tasks/system_task.d ./Core/Src/tasks/system_task.o ./Core/Src/tasks/system_task.su
